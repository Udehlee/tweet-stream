...
func (x *Comment) GetPostedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.PostedAt
	}
	return nil
...
const file_comment_proto_rawDesc = "" +
	"\n" +
	"\rcomment.proto\x12\acomment\x1a\n" +
	"user.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"|\n" +
	"\aComment\x12\x1e\n" +
	"\x04user\x18\x01 \x01(\v2\n" +
	".user.UserR\x04user\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x127\n" +
	"\tposted_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\bpostedAtB$Z\"github.com/Udehlee/tweet-stream/pbb\x06proto3"
...
var file_comment_proto_depIdxs = []int32{
	1, // 0: comment.Comment.user:type_name -> user.User
	2, // 1: comment.Comment.posted_at:type_name -> google.protobuf.Timestamp
